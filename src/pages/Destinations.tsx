...
const destinations: Destination[] = [
  ...
  {
    img: 'images/kosambi.avif',
    key: 'kaushambi',
    country: 'India',
    flag: '🇮🇳',
    category: ['buddhist', 'heritage'],
    highlight: 'Vatsa Kingdom Legacy',
    title: 'Kaushambi — Ancient Vatsa Capital & Buddhist Sanctuary',
    desc: 'An ancient metropolis where the Buddha spent much of his later life. Known for the Ghoshitarama Monastery ruins and its role as a crossroad of ancient trade and spirituality in Uttar Pradesh. It was the capital of the Vatsa Kingdom and witnessed many profound discourses.',
    sites: ['Ghoshitarama Monastery Ruins', 'Ashokan Pillar', 'Ancient Fortification Walls', 'Digambar Jain Temple', 'Yamuna River Ghats'],
    tips: 'Best visited as a day trip from Prayagraj (45 km). October to March is the ideal time. Carry water and wear comfortable walking shoes as the site is spread out.',
    cuisine: [
      { name: 'Prayagraj Kachori-Sabzi', desc: 'Hearty spiced lentils stuffed breads served with tangy potato curry, a staple of the region.' },
      { name: 'Petha', desc: 'A translucent soft candy made from ash gourd, famous across the plains of Uttar Pradesh.' },
      { name: 'Mughlai Kebabs', desc: 'Succulent grilled meats influenced by the royal kitchens of nearby historical centers.' },
    ],
    activities: ['Monastery Ruins Walk', 'Heritage Photography', 'Yamuna River Reflection', 'Archaeological Exploration'],
  },
  {
    img: 'images/nalanda1.jpg',
    key: 'nalanda',
    country: 'India',
    flag: '🇮🇳',
    category: ['buddhist', 'heritage'],
  ...
  {
    img: 'images/ramagram.jpg',
    key: 'ramagram',
    country: 'Nepal',
    flag: '🇳🇵',
    category: ['buddhist', 'heritage'],
    highlight: 'The Untouched Relics',
    title: 'Ramagram (Nawalparasi) — The Sacred Serpent-Guarded Stupa',
    desc: 'Famous as the only one of the original eight relic stupas that remained unopened by Emperor Ashoka. Legend says a serpent king (Nagaraja) deterred Ashoka from taking the relics, leaving the original bodily remains of the Buddha intact beneath this brick mound in the peaceful farmlands of Nepal.',
    sites: ['Ramagrama Stupa (Koliya Dynasty Stupa)', 'Jharahi River (Sacred Bathing)', 'Panditpur (Ancient Koliya Palace Ruins)', 'Japanese Peace Temple'],
    tips: 'Located 50km east of Lumbini. Most easily visited as a half-day excursion from Lumbini or Bhairahawa. Carry water as the site is rural and evocative of ancient stillness.',
    cuisine: [
      { name: 'Thakali Thali', desc: 'A premium Nepali set with buckwheat or rice, ghee-topped lentils, spicy pickles, and local greens.' },
      { name: 'Momo (Nepal)', desc: 'Hand-folded dumplings filled with local mountain spices and vegetables, served with tomato-sesame achaar.' },
      { name: 'Sel Roti with Chiya', desc: 'Traditional ring-shaped rice snack paired with local spiced milk tea.' },
    ],
    activities: ['Stupa Meditation', 'Sacred Kora (Circumambulation)', 'Village Heritage Walk', 'Panditpur Archaeological Tour'],
  },
  {
