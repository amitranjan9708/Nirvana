...
const tours: Tour[] = [
  ...
  },
  {
    ...
    destinations: ['Kathmandu', 'Lumbini', 'Ramagram', 'Bodh Gaya', 'Nalanda', 'Varanasi', 'Sarnath', 'Kaushambi', 'Shravasti', 'Kushinagar'],
    category: 'buddhist',
    ...
    itinerary: [
      ...
      { day: 4, title: 'Lumbini to Ramagram — The Unopened Stupa', desc: 'Drive to Ramagram (50 km). Meditate at the Ramagrama Stupa — the only one of the eighth original relic stupas that was never opened. Learn about the legend of the serpent king (Nagaraja) who guarded the relics. Continue the meditative journey through the surrounding rural landscape. Evening return to Lumbini for a reflection circle.' },
      ...
      { day: 11, title: 'Kaushambi Excursion & Transfer to Shravasti', desc: 'Early departure for Kaushambi (45 km from Prayagraj). Explore the ruins of Ghoshitarama Monastery, where the Buddha stayed and delivered several discourses. See the Ashokan Pillar and the ancient city fortifications. Continue the journey to Shravasti (280 km, ~6 hrs). Evening arrival and rest.' },
